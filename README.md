...
👉 **[Try it now!](https://huangpipip.github.io/daily-arXiv-ai-enhanced/)** - No installation required
...
Otherwise, you can directly use this repo in https://huangpipip.github.io/daily-arXiv-ai-enhanced/. Please star it if you like :)
...
5. [Optional] Set a password in `secrets.ACCESS_PASSWORD` if you do not wish others to access your page. (see https://github.com/huangpipip/daily-arXiv-ai-enhanced/pull/64)
...
10. Set up GitHub pages: Go to your own repo -> Settings -> Pages. In `Build and deployment`, set `Source="Deploy from a branch"`, `Branch="main", "/(root)"`. Wait for a few minutes, go to https://\<username\>.github.io/daily-arXiv-ai-enhanced/. Please see this [issue](https://github.com/huangpipip/daily-arXiv-ai-enhanced/issues/14) for more precise instructions.

## GitHub Pages subpath deployment

This repository is a static site at the repository root. It is suitable for a GitHub Pages project URL such as:

```text
https://Hwei-esay.github.io/<repository-name>/
```

For the local folder name used here, the expected project URL is:
...
[![Stargazers over time](https://starchart.cc/huangpipip/daily-arXiv-ai-enhanced.svg?variant=adaptive)](https://starchart.cc/huangpipip/daily-arXiv-ai-enhanced)
